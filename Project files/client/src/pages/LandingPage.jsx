...
<h1 className="banner-h1">Fly Smarter. Book Faster. Travel Better.</h1>

  <p className="banner-p">
    Find the best air travel options with real-time availability, competitive fares, and seamless booking. Whether for business or leisure, we connect you to destinations worldwide — faster, smarter, and stress-free.
  </p>
</div>
          ...
          <div className="Flight-search-container input-container mb-4">
                  ...
                  <div className='Flight-search-container-body'>
                    ...
                    ""}
                    <div>
                      <button className="btn btn-primary shadow" onClick={fetchFlights}>Find Flights</button>
                    </div>
